...
public class PasswordValidator_04 {
    ...
    public static boolean isValidContent(String password) {
        ...
        //валидно съдържание: съдържа само букви или цифри
        //невалидно съдъжание: нещо различно от буква или цифр
    ...
    //true -> ако броя е валиден >= 2
    //false -> ако броя е невалиден < 2
